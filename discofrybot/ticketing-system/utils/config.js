// ticketing-system/utils/config.js
// Optional local override; primary env values come from docker-compose/1Password.
...
if (missingConfig) {
    console.error("🚨 Halting bot startup due to missing critical configurations. Please check your .env file and ticketing-system/utils/config.js");
    process.exit(1);
}
